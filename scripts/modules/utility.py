...
class LogDecorator:
    def __init__(self, start_log_message, finish_log_message):
        self.start_log_message = start_log_message
...
def log(start_log_message, finish_log_message):
    return LogDecorator(start_log_message, finish_log_message)